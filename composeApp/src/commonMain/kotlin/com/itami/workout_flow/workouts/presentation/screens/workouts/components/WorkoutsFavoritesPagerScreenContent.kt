...
@Composable
internal fun WorkoutsFavoritesPagerScreenContent(
    modifier: Modifier = Modifier,
    lazyListState: LazyListState = rememberLazyListState(),
    favoriteWorkoutsPreviewsFlow: Flow<List<WorkoutPreview>>,
    onWorkoutPreviewClick: (WorkoutPreview) -> Unit,
) {
    val favoriteWorkoutsPreviews by favoriteWorkoutsPreviewsFlow.collectAsStateWithLifecycle(emptyList())
    ...
    LazyColumn(
        ...
        items(items = favoriteWorkoutsPreviews, key = { it.id }) { workoutPreview ->
            WorkoutPreviewItem(
